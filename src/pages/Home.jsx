...
function Hero() {
  return (
    <section className="bg-gradient-to-br from-white from-50% to-[#296eb4]
e py-24 px-6 text-center">
      ...
      <div className="flex items-center justify-center gap-4">
        <button className="flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white font-semibold px-6 py-3 rounded-lg transition-colors text-sm">
          <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
          </svg>
          Start a Build
        </button>
        <button className="border border-orange-400 text-orange-500 hover:bg-orange-50 font-semibold px-6 py-3 rounded-lg transition-colors text-sm">
          Browse Deals
        </button>
      </div>
    </section>
  ...
  return (
    <section className="py-20 px-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
        ...
        <div className="col-span-2 md:col-span-1 row-span-2 bg-blue-600 rounded-2xl p-6 flex flex-col justify-end min-h-[260px]">
